  ...
  "templating": {
    "list": [
      ...
      },
      {
        ...
        "definition": "label_values(go_info{cluster=~\"$cluster\"}, region)",
        "hide": 0,
        "includeAll": true,
        "label": "Region",
        "multi": true,
        ...
        "options": [],
        "query": {
          "query": "label_values(go_info{cluster=~\"$cluster\"}, region)",
          "refId": "StandardVariableQuery"
        },
        "refresh": 1,
        "regex": "",
      ...
      },
      {
        ...
        "definition": "label_values(go_info{cluster=~\"$cluster\",region=~\"$region\"}, env)",
        "hide": 0,
        "includeAll": true,
        "label": "Env",
        "multi": true,
        ...
        "options": [],
        "query": {
          "query": "label_values(go_info{cluster=~\"$cluster\",region=~\"$region\"}, env)",
          "refId": "StandardVariableQuery"
        },
        "refresh": 1,
        "regex": "",
      ...
      },
      {
        ...
        "definition": "label_values(go_info{cluster=~\"$cluster\",region=~\"$region\",env=~\"$env\",role=\"{{.Title}}\"}, instance)",
        "hide": 0,
        "includeAll": true,
        "label": "Instance",
        "multi": true,
        ...
        "options": [],
        "query": {
          "query": "label_values(go_info{cluster=~\"$cluster\",region=~\"$region\",env=~\"$env\",role=\"{{.Title}}\"}, instance)",
          "refId": "StandardVariableQuery"
        },
        "refresh": 1,
        "regex": "",
      ...
      },
      {
        ...
        "definition": "label_values(go_info{cluster=~\"$cluster\",region=~\"$region\",env=~\"$env\",role=\"{{.Title}}\"}, container_ip)",
        "hide": 0,
        "includeAll": true,
        "label": "Container IP",
        "multi": true,
        ...
        "options": [],
        "query": {
          "query": "label_values(go_info{cluster=~\"$cluster\",region=~\"$region\",env=~\"$env\",role=\"{{.Title}}\"}, container_ip)",
          "refId": "StandardVariableQuery"
        },
        "refresh": 1,
        "regex": "",
      ...
      },
      {
        ...
        "definition": "label_values(go_info{cluster=~\"$cluster\",region=~\"$region\",env=~\"$env\",role=\"{{.Title}}\"}, container_name)",
        "hide": 0,
        "includeAll": true,
        ...
        "options": [],
        "query": {
          "query": "label_values(go_info{cluster=~\"$cluster\",region=~\"$region\",env=~\"$env\",role=\"{{.Title}}\"}, container_name)",
          "refId": "StandardVariableQuery"
        },
        "refresh": 1,
        "regex": "",
